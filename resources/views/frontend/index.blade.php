    ...
    <section class="blog-area section-gap">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="card mb-3">
                        <img class="card-img-top" src="{{asset('assets/img/artikel/' .$data->foto)}}" alt="Card image cap">
                        <div class="card-body">
                                <div class="detais">
                                        <ul class="tags">
                                        ...
                                        <h5 class="card-title"><a href="/blog/{{$data->konten}}">
                                            <h4>{{$data->judul}}</h4></a></h5>
                                            <p class="card-text"><small class="text-muted">{{$data->created_at->format('d M Y')}}</small></p>
                                    </div> 
                        </div>
                    </div>
                </div>
